...
MAX_DOWNLOAD_THREADS = 2 # Higher = faster downloads but higher chance for failiure
...
RECORD_PLAYTIME = True # Whether to record game playtime when auto.py is running (records in hours)
